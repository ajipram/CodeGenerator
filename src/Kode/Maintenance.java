...
public class Maintenance extends javax.swing.JInternalFrame {
    ...
    public String[] Data(){
        ...
        isi[5] = strCab.substring(0, 3);
        isi[6] = strCab.substring(5);
        isi[7] = strWil.substring(0, 3);
        isi[8] = strWil.substring(5);
        ...
        isi[15] = strMit.substring(0, 3);
        isi[16] = strMit.substring(5);
        return isi;
    }
    ...
    private void searchKode(String cmb, String key){
        try{
            ...
            String query = "Select * from KDMaintenance where "+ cmb +" like '%"+ key +"%'"; 
            ResultSet rs = state.executeQuery(query);
    ...
    private void initComponents() {
        ...
        cmbCari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "No_Bukti", "Tanggal" }));
    ...
    private void btnGenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateActionPerformed
        ...
        if(txtCustomer.getText().equals("")){
            ...
            LocalDateTime now = LocalDateTime.now();
            String date = dtf.format(now);
            txtNoBukti.setText(kdCust+"-"+kdCab+"-"+date+nomor);
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        try{
            query.Hapus("HMaintenance", "No_Bukti", txtNoBukti.getText());
    ...
    public void getData() {
        ...
        txtNoKode.setText(tblModel.getValueAt(tabelKode.convertRowIndexToModel( row),0).toString());
        txtNoBukti.setText(tblModel.getValueAt(tabelKode.convertRowIndexToModel( row),1).toString());
        txtCustomer.setText(tblModel.getValueAt(tabelKode.convertRowIndexToModel( row),3).toString());
        txtCustomer.setText(tblModel.getValueAt(tabelKode.convertRowIndexToModel( row),3).toString());
    }
